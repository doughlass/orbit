...
- formatted detail views for Route53 records and EC2 instances ([#81](https://github.com/doughlass/orbit/pull/81))
...
- sync README with the real resource set ([#71](https://github.com/doughlass/orbit/pull/71))
