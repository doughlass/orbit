...
## [1.1.0](https://github.com/doughlass/orbit/compare/v1.0.2...v1.1.0) - 2026-08-24
...
- *(ecr)* handle float epoch timestamps in format_epoch_seconds
...
- use CARGO_PKG_VERSION instead of ORBIT_VERSION env var
