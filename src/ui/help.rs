...
pub fn render(f: &mut Frame, app: &App) {
    ...
    help_text.extend(vec![
        ...
        Line::from(""),
        create_section("Sorting"),
        create_key_line("← / →", "Move column cursor (underlined header)"),
        create_key_line("Tab", "Sort by cursor column, or flip direction"),
        create_key_line("Shift+Tab", "Clear sort (back to API order)"),
